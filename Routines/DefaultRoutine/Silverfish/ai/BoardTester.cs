namespace HREngine.Bots
{
    ...
    public class BoardTester
    {
        ...
        public BoardTester(string data = "")
        {
            ...
            CardDB.Card heroability = CardDB.Instance.getCardDataFromID(CardDB.cardIDEnum.HERO_08bp);
            CardDB.Card enemyability = CardDB.Instance.getCardDataFromID(CardDB.cardIDEnum.HERO_08bp);
            ...
            foreach (string sss in lines)
            {
                ...
                if (s.StartsWith("start calculations, current time: "))
                {
                    ...
                    this.botBehavior = s.Split(' ')[4].Split(' ')[0];
